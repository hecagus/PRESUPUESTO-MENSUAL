...
const calcularCostoPorKm = () => {
    ...
    const kmTotal = ultimoKm - primerKm;
    ...
    const costoTotal = cargas.reduce((sum, c) => sum + safeNumber(c.costo), 0);
    const costo = costoTotal / kmTotal;
    
    state.parametros.costoPorKm = costo;
    return costo;
};
