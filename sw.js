const CACHE='hecagus-finance-2.2.0-shell-v1';
const APP_SHELL=[
  ...
  './js/01_consts_utils.js','./js/02_data.js','./js/03_render.js','./js/04_charts.js','./js/05_init.js','./js/06_income_ui.js','./js/07_sync.js','./js/08_pwa.js','./js/10_onboarding.js','./js/11_savings_goals.js','./js/12_savings_ui.js','./js/13_financial_life.js','./js/14_calendar_ui.js','./js/firebase-config.js'
];
